...
if bake_result__coverRandomly is not None:
    bake_result__coverRandomly.save(
        "./examples/cat_pic/outputs/cat__result_coverRandomly.png",
...
if bake_result__stampWindowed is not None:
    bake_result__stampWindowed.save(
        "./examples/cat_pic/outputs/cat__result_stampWindowed.png",
        should_overwrite_if_existed=True
    )
...
if bake_result__nudgeAll is not None:
    bake_result__nudgeAll.save(
        "./examples/cat_pic/outputs/cat__result_nudgeAll_25.png",
        should_overwrite_if_existed=True
    )
...
if bake_result__nudgeAll is not None:
    bake_result__nudgeAll.save(
        "./examples/cat_pic/outputs/cat__result_nudgeAll_50.png",
        should_overwrite_if_existed=True
    )
...
if bake_result__nudgeAll is not None:
    bake_result__nudgeAll.save(
        "./examples/cat_pic/outputs/cat__result_nudgeAll_75.png",
        should_overwrite_if_existed=True
    )
...
if bake_result__nudgeAllAdaptively is not None:
    bake_result__nudgeAllAdaptively.save(
        "./examples/cat_pic/outputs/cat__result_nudgeAllAdaptively.png",
        should_overwrite_if_existed=True
    )
...
if bake_result__biasAll is not None:
    bake_result__biasAll.save(
        "./examples/cat_pic/outputs/cat__result_biasAll_25.png",
        should_overwrite_if_existed=True
    )
...
if bake_result__biasAll is not None:
    bake_result__biasAll.save(
        "./examples/cat_pic/outputs/cat__result_biasAll_50.png",
        should_overwrite_if_existed=True
    )
...
if bake_result__biasAll is not None:
    bake_result__biasAll.save(
        "./examples/cat_pic/outputs/cat__result_biasAll_75.png",
        should_overwrite_if_existed=True
    )
